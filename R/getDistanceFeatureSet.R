...
getDistanceFeatureSet = function(x, include.costs = FALSE, normalize = FALSE, ...) {
  ...
  measureTime(expression({
    ...
    if (!normalize) {
      ...
      feat.set = c("fraction_shorter_mean_distance_norm" = normalizeFeature(feat.set$fraction_shorter_mean_distance, 1 - 2 / n.cities, n.cities * (n.cities / 4 - 1) / (n.cities * (n.cities - 1))),
                   ...
                   "distance_var_norm" = statistics.on.distances$distance_norm_var,
